...
<div class="l-section">
  <div class="l-section-label">Мэрбери против Мэдисона (1803): как появился judicial review</div>
  <p class="l-text">Это самое известное дело в истории американского права. Его суть часто объясняют сухо — «суд получил право проверять законы на конституционность». На самом деле это политическая интрига, в которой председатель Верховного суда Джон Маршалл совершил блестящий манёвр: проиграл конкретное дело, но навсегда расширил власть судебной системы.</p>

  <div class="concept-card">
    <div class="concept-card-title">Что произошло политически</div>
    <div class="concept-card-body">На выборах 1800 года федералист Джон Адамс проиграл Томасу Джефферсону. В последние дни своего президентства Адамс и уходящий Конгресс спешно назначили десятки своих сторонников на судейские должности — их прозвали <strong>«midnight judges»</strong> («полуночные судьи»). Госсекретарь Джон Маршалл (тот самый, который через несколько недель станет председателем Верховного суда) подписал <span class="l-en">commissions</span> — документы о назначении — но физически не успел доставить все бумаги до инаугурации Джефферсона. Уильям Мэрбери был одним из таких назначенцев: бумага на него была подписана, но не доставлена.</div>
  </div>

  <div class="concept-card">
    <div class="concept-card-title">Что произошло юридически</div>
    <div class="concept-card-body">Джефферсон, придя к власти, приказал новому госсекретарю Джеймсу Мэдисону не передавать недоставленные commissions. Мэрбери подал иск прямо в Верховный суд, требуя выдать <span class="l-en">writ of mandamus</span> — судебный приказ, обязывающий Мэдисона передать документ. Основанием для обращения напрямую в Верховный суд была секция 13 <span class="l-en">Judiciary Act of 1789</span>, которая давала Верховному суду право выдавать такие приказы в первой инстанции.</div>
  </div>

  <div class="concept-card">
    <div class="concept-card-title">Дилемма Маршалла</div>
    <div class="concept-card-body">Маршалл — теперь уже председатель Верховного суда — оказался в ловушке. Если он прикажет Мэдисону выдать бумагу, Джефферсон просто проигнорирует приказ, и суд публично потеряет авторитет. Если откажет — это будет капитуляция перед исполнительной властью. Маршалл нашёл третий путь.</div>
  </div>

  <div class="concept-card">
    <div class="concept-card-title">Как Маршалл решил дело</div>
    <div class="concept-card-body">Он построил решение в три шага: <strong>(1)</strong> у Мэрбери <em>есть</em> право на свою commission — Адамс её подписал, значит назначение состоялось; <strong>(2)</strong> Мэдисон <em>обязан</em> её передать — это правовая обязанность, а не политическое усмотрение; <strong>(3) <u>но</u></strong> Верховный суд <em>не может</em> выдать mandamus в этом деле. Почему? Потому что секция 13 Judiciary Act, дающая такое право, <strong>противоречит Конституции</strong>: статья III перечисляет строгий перечень дел, рассматриваемых Верховным судом в первой инстанции, и дело Мэрбери туда не входит. Конгресс не вправе расширять юрисдикцию Верховного суда обычным законом.</div>
  </div>

  <div class="hbox green">
    <div class="hbox-label">Гениальный ход</div>
    <div class="hbox-text">Маршалл <strong>отказал Мэрбери</strong> — то есть формально проиграл федералистам — но сделал это на основании того, что закон Конгресса <u>неконституционен</u>. Джефферсону нечего было игнорировать: никакого приказа исполнительной власти суд не дал. А вот принцип, что <strong>суд может признавать законы Конгресса неконституционными</strong>, вошёл в право США навсегда.</div>
  </div>

  <div class="l-section-label" style="margin-top:24px">Ключевая цитата из решения</div>
  <div class="quote-box">
    <div class="quote-text">«It is emphatically the province and duty of the judicial department to say what the law is.»</div>
    <div class="quote-author">— Chief Justice John Marshall, Marbury v. Madison (1803)</div>
  </div>
  <p class="l-text"><strong>Перевод:</strong> «Сказать, что́ есть закон — это безусловно сфера и обязанность судебной власти». Именно из этой фразы растёт вся современная доктрина <span class="l-en">judicial review</span>.</p>

  <div class="hbox blue">
    <div class="hbox-label">Почему это важно для Bar Exam</div>
    <div class="hbox-text">Marbury v. Madison — базовое дело для блока <strong>Constitutional Law</strong>. На экзамене спросят: откуда берётся право судов проверять конституционность законов? Ответ: <em>не</em> из текста Конституции напрямую, а из толкования статьи III Верховным судом в деле Marbury. Это <span class="l-en">implied power</span> судебной власти.</div>
  </div>

  <div class="hbox">
    <div class="hbox-label">Связка с другими темами</div>
    <div class="hbox-text">Через 16 лет Маршалл в деле <strong>McCulloch v. Maryland (1819)</strong> таким же способом расширит полномочия Конгресса через Necessary and Proper Clause. Два решения вместе сформировали баланс федеральной власти: сильный Конгресс + сильный Верховный суд, который может Конгресс сдерживать.</div>
  </div>
</div>
